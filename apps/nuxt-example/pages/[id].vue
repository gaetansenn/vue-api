  ...
  <div class="container mx-auto px-4 py-8">
    ...
    <div v-else-if="user.data.value" class="bg-white shadow-lg rounded-lg overflow-hidden">
      ...
      <div class="p-8 border-t border-gray-200">
        <h2 class="text-xl font-semibold text-gray-800 mb-4">Départements et Projets</h2>
        <div v-for="(dept, deptName) in user.data.value.departments" :key="deptName" class="mb-6">
          ...
          <p class="text-gray-600 mb-2">Rôle: {{ dept.role }}</p>
          <h4 class="text-md font-semibold text-gray-700 mb-2">Projets:</h4>
          <ul class="list-disc list-inside">
            <li v-for="project in dept.projects" :key="project.name" class="text-gray-600">
              ...
              <span :class="{
                ...
                'text-blue-600': project.status === 'Planning'
              }">
                {{ project.status }}
              </span>
            </li>
